...
# Use WA reconstruction from 2017 assessment
WA_hist_2017 <- filter(comm2017, AGENCY_CODE == 'W', Year < 1981) |>
...
comm_draft_landings <- yt_n_catch_pacfin |> 
  filter(AGENCY_CODE != 'O' | PACFIN_YEAR == 2024,
...
<!-- Note that the sample sizes for ages in 2022-2024 are lower than other years, especially midwater in 2022 which only has 14 ages. -->

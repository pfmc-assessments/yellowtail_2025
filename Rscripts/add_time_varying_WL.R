...
add_tv_wl <- function(model, sex_specific_wl = T, wcbts_start_yr = 2003, wcbts_end_yr = 2024){
  ...
  model$ctl$MG_parms[c(7,8, 19, 20), 13] <- model$ctl$N_Block_Designs # block design reference #
  ...
  if(sex_specific_wl){
    ...
    model_rownames_f <- c(paste0("Wtlen_1_Fem_GP_1_BLK", model$ctl$N_Block_Designs, "repl_", wcbts_yrs), 
                          paste0("Wtlen_2_Fem_GP_1_BLK", model$ctl$N_Block_Designs, "repl_", wcbts_yrs))
    model_rownames_m <- c(paste0("Wtlen_1_Mal_GP_1_BLK", model$ctl$N_Block_Designs, "repl_", wcbts_yrs), 
                          paste0("Wtlen_2_Mal_GP_1_BLK", model$ctl$N_Block_Designs, "repl_", wcbts_yrs))

...
TODO: expand on the bullets below

* Extended data time series
* New data sources: H&L index, recruitment index, etc.
* Discards [Ian write this]
* Rec WA in biomass not numbers [Kiva]
* Rec fleets combined [Kiva]
* Foreign fleets [Kiva]


### Modeling Platform and Structure

The stock assessment is conducted in Stock Synthesis 

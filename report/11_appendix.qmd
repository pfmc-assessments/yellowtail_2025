...
## Oceanographic Time Series
  ...
  Overall the GLORYS analysis followed @Tolimieri2018 and @Haltuch2020 modified for the life history of Yellowtail rockfish. More specifically, data for water column temperature, and bottom temperature were downloaded as daily values for 40-48 °N and processed as follows for each life-history-stage predictor:

1) Subsetted data by depth (@tbl-LH) 
2) Calculated the daily average
3) Subsetted #2 by the relevant time periods [@Tolimieri2018]

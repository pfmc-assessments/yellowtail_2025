...
titles <- c(
    "Estimated OFL values by state of nature for yellowtail rockfish catch stream A: default harvest control rule",
    "Estimated OFL values by state of nature for yellowtail rockfish catch stream M: avg. ACL attainment = 55%"
)

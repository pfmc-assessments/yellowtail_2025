...
table |> 
  ...
  gt::tab_header(
    "Decision table summary of 10 year projections beginning in 2027 for alternative states of nature based on an axis of uncertainty about natural mortality for the base model. Columns range over low, base, and high states of nature and rows range over different catch level assumptions. EXPAND HERE."
  )

...
-   Further investigation into an index for the commercial logbook dataset from earlier periods. 
    -   This was not done. An new fishery-independent hook and line index and a number of indices of recruitment were explored instead.
...
1.  No new midwater surveys have begun in the last eight years, and the likelihood of new surveys in future years is low. The current survey index has a distinct autocorrelated pattern suggesting changes in the population, but the model was unable to fit it. The STAT understands that the WCGBTS has collected echosounder data over the years which has not been analyzed to date. Analyzing this data and exploring the relationship between acoustic data and measured biomass from the bottom trawl gear will help understand potential variability in catchability. Identifying drivers of bottom trawl catchability (e.g., environmental drivers, density-dependence and/or schooling behavior) would also be helpful. This would be useful for other midwater species, as well. (high)

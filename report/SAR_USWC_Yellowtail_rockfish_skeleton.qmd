...
#| warning: true
#| eval: true
# CUSTOM CHANGE: source additional script to create r4ss plots and exec summary tables
source("custom_code.R")
```
...
Oken, K.L., I.G. Taylor, M.L. Feddern, A.D. Whitman, F.P. Caltabellotta. Status of the Yellowtail rockfish stock off the U.S. West Coast north of 40°10$\prime$) in 2025. Prepared by [COMMITTEE]. [XX] p.

...
![Spawning output (trillions of eggs, top), and relative spawning output (bottom) from third steps (model changes) in model bridging. Uncertainty is shown for the 2017 model and the final bridging step (the 2025 model).](figures/bridging/bridging3_comparison.png){#fig-bridge3 fig-alt="TODO"}

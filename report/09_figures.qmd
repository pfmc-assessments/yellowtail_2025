...
#| warning: false
#| eval: true
#| fig-cap: "Distribution of catch by year in the WCGBTS."
#| fig-alt: "Bubbles of different sizes are shown next to a map of the U.S. West Coast, with the largest points between about 46 and 48 degrees north (off the coast of Washington State). There is a lot of variability among years with the biggest bubbles in 2016, 2017, and 2019."
#| fig-pos: H

knitr::include_graphics(
    "../Data/Raw_not_confidential/wcgbts/plots/cpue_by_year_map.png"
)
```
...
#| warning: false
#| eval: true
#| fig-cap: "Comparison of lengths (cm) of fish caught in the Oregon and Washington surveys"
...
#| warning: false
#| eval: true
#| fig-cap: "Time series of the relative index of abundance from the combined Oregon and Washington hook and line surveys"
#| fig-alt: "An annual relative index of abundance plotted from 2010 to 2024 with error bars."

knitr::include_graphics(
    "Figures/HL_Index.png"
)
```
...
#| warning: false
#| eval: true
#| fig-cap: "Mean age for the Hook and Line Survey with 95% confidence intervals based on adjusted input sample sizes. The blue line is the model expectation."
#| fig-alt: "The Mean age is uncertain due to low sample sizes and shows little change over the 2010 to 2024 period with data. The model expectation fits reasonably well."

...
![Ending-year selectivity at age derived from selectivity at length (solid female, dashed male).](r4ss_plots\sel01_multiple_fleets_length1.png){fig-alt='See the AGE\_SELEX table (with Factor = "Asel2") in Report.sso file for values.' #fig-sel-age}

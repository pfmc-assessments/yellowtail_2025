...
Fecundity is based on @dick_meta-analysis_2017 and is unchanged from the 2017 assessment. The relationship for spawning output for an individual is `r mod_in$ctl$MG_parms['Eggs_alpha_Fem_GP_1', 'INIT']`\*length^`r mod_in$ctl$MG_parms['Eggs_alpha_Fem_GP_2', 'INIT']`^.

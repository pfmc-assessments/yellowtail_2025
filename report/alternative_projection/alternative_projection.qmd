...
model <- SS_output(here('model_runs', '5.11_adj_hcr'), verbose = FALSE, printstats = FALSE)
...
table <- catch_only_projection_table(model,
  ...
  select(-"Spawning Output", -'Actual & Assumed Removals') |>
